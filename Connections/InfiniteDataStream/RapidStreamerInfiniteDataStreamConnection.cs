...
namespace RapidStreamer.Clients.DotNet.Connections.InfiniteDataStream
{
    internal
#if !DEBUG
        sealed
#endif
        class RapidStreamerInfiniteDataStreamConnection : AbstractRapidStreamerConnection<RapidStreamerInfiniteDataStreamConnectionConfiguration>
    {
        private readonly HttpClient _httpClient;

        private readonly Channel<string> _receivedMessagesChannel;

        public RapidStreamerInfiniteDataStreamConnection(RapidStreamerInfiniteDataStreamConnectionConfiguration connectionConfiguration, ILoggerProvider loggerProvider)
