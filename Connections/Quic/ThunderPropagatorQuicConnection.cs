...
namespace ThunderPropagator.Clients.DotNet.Connections.Quic
{
    ...
    internal
        ...
        sealed
#endif
        class ThunderPropagatorQuicConnection : AbstractThunderPropagatorConnection<ThunderPropagatorQuicConnectionConfiguration>
    {
        private readonly QuicClientConnectionOptions _clientConnectionOptions;
        private QuicConnection? _connection;

        public ThunderPropagatorQuicConnection(ThunderPropagatorQuicConnectionConfiguration connectionConfiguration, ILoggerProvider loggerProvider)
