...
namespace ThunderPropagator.Clients.DotNet.Channels
{
    internal
        ...
        sealed
#endif
        class ThunderPropagatorQuicChannel : AbstractThunderPropagatorChannel
    {
        public ThunderPropagatorQuicChannel(string name, IThunderPropagatorConnection thunderPropagatorConnection, ILoggerProvider loggerProvider)
